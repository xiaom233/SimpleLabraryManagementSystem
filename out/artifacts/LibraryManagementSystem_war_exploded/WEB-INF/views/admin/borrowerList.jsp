...
<div id="nav">
    ...
    <div class="nav_con">
        <ul>
            ...
            <li><a href="<c:url value="#" />">借阅者管理</a></li>
...
<a href="<c:url value="/admin/addBorrower" />">注册新借阅用户</a>
<div id="h1test" class="ManagerList">
            ...
            <div>
                <c:forEach items="${paginationSupport.items}" var="borrower">
                    <dl>
                        ...
                        <dd><a href="<c:url value="/admin/borrowerProfile?account=${borrower.account}" />"
    ...
    <div>
        ...
        <c:if test="${paginationSupport.previousPage}">
            <a href="<c:url value="borrowerList?pageNo=${paginationSupport.currentPageNo-1}" />">上一页</a>
        </c:if>
        <c:if test="${paginationSupport.nextPage}">
            <a href="<c:url value="borrowerList?pageNo=${paginationSupport.currentPageNo+1}" />">下一页</a>
        </c:if>
    </div>
