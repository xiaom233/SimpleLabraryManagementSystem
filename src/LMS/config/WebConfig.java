...
import LMS.advice.AdminInterceptor;
import LMS.advice.BorrowerInterceptor;
import LMS.advice.RootInterceptor;
...
//				.addPathPatterns(new String[] { "/admin", "/admin/**" })//添加拦截
//				.excludePathPatterns("/");// excludePathPatterns 排除拦截
//
//		super.addInterceptors(registry);
//		registry.addInterceptor(new BorrowerInterceptor())
//				.addPathPatterns(new String[]{"/**"})
//				.excludePathPatterns("/");
//		super.addInterceptors(registry);
//		registry.addInterceptor(new RootInterceptor())
//				.addPathPatterns(new String[]{"/admin/adminList"})
//				.excludePathPatterns("/");
//		super.addInterceptors(registry);
	}
